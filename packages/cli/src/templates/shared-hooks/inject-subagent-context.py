...
Context Source: Rudder active task resolver points to task directory
...
AGENT_IMPLEMENT = "rudder-implement"
AGENT_CHECK = "rudder-check"
AGENT_RESEARCH = "rudder-research"
...
def main():
    if os.environ.get("RUDDER_HOOKS") == "0" or os.environ.get("RUDDER_DISABLE_HOOKS") == "1":
        sys.exit(0)
