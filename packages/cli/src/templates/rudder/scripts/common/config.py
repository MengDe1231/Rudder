#!/usr/bin/env python3
"""
Rudder configuration reader.

Reads settings from .rudder/config.yaml with sensible defaults.
"""
...
def _strip_inline_comment(value: str) -> str:
    ...
    Mirrors :func:`common.rudder_config._strip_inline_comment` so both
...
def get_spec_base(package: str | None = None, repo_root: Path | None = None) -> str:
    """Get the spec directory base path relative to .rudder/.
