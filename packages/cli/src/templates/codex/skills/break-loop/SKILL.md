...
- [ ] Update `.rudder/spec/guides/` thinking guides
- [ ] Update `.rudder/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `.rudder/spec/`, sync to `src/templates/markdown/spec/`
