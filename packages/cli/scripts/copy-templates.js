 ...
 * - src/templates/rudder/ - Workflow scripts and config
 ...
 *
 * Note: We NO LONGER copy from the project's own .rudder/, .cursor/, .claude/
 * because those may be customized for the Rudder project itself.
 */
