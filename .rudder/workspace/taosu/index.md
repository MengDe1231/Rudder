...
| 144 | 2026-05-04 | Integrate mem-poc into rudder CLI as 'rudder mem' subcommand | `e1b368d` | `feat/v0.6.0-beta` |
...
| 141 | 2026-05-02 | rudder uninstall command (#221) | `255d499` | `feat/v0.5.0-rc` |
| 140 | 2026-05-01 | regression test for opencode plugin export shape (#212) | `5e938d9` | `feat/v0.5.0-rc` |
| 139 | 2026-05-01 | fix opencode rudder-research persist (#211) | `fd32162` | `feat/v0.5.0-rc` |
| 138 | 2026-04-30 | Workflow-state breadcrumb SoT collapse + commit step + auto-active create | `ad49153`, `c52ece2` | `feat/v0.5.0-beta` |
| 137 | 2026-04-30 | Fix issue #204: rudder init --yes non-interactive + bootstrap recovery | `346003d`, `589f753`, `6fe9489` | `feat/v0.5.0-beta` |
...
| 130 | 2026-04-24 | Fix AGENTS.md /rudder:start reference (issue #192) | `7e3592f`, `9366d86` | `feat/v0.5.0-beta` |
...
| 120 | 2026-04-20 | v0.5.0-beta.5/6: rudder- prefix sub-agents, drop model:opus, fix codex read-only | `79801ed`, `66a1ae2`, `fe1d1ff`, `e49975d` | `feat/v0.5.0-beta` |
...
| 105 | 2026-03-26 | StatusLine: 集成 Rudder 任务状态到 CC 状态栏 | `9e4411c` | `feat/v0.4.0-beta` |
...
| 100 | 2026-03-13 | fix: rudder update skips unregistered Python scripts | `8e3e465`, `ca06ab5` |
...
| 79 | 2026-03-09 | 提取 rudder-meta skill 到 marketplace/ + skills CLI 调研 | `9195f89` |
...
| 21 | 2026-01-31 | Add rudder-meta skill & sync hotfix | `90bdb89`, `b786434`, `dfc0266`, `2f0fe16`, `2b67fd7` |
| 20 | 2026-01-31 | Add rudder-meta skill documenting Rudder system | `90bdb89` |
