...
Create the `0.5.0-beta.17` migration manifest and docs-site changelog following `.claude/commands/rudder/create-manifest.md`.
...
* The current branch has commits after `v0.5.0-beta.16` covering:
  ...
  * bundled built-in `rudder-meta` skill installation;
...
* Release workflow source: `.claude/commands/rudder/create-manifest.md`
