...
| Old Path | New Path |
|----------|----------|
| `.rudder/scripts/*.sh` | `.rudder/scripts/*.py` |
| `.rudder/scripts/common/*.sh` | `.rudder/scripts/common/*.py` |
| `.rudder/scripts/multi-agent/*.sh` | `.rudder/scripts/multi_agent/*.py` |
...
| `./.rudder/scripts/task.sh` | `python3 ./.rudder/scripts/task.py` |

## After Migration

Run `rudder update --migrate` to remove the old shell scripts from your project.
...
1. Search for files containing `.rudder/scripts/*.sh` references and update to `.py`
...
5. Run `rudder update --migrate` to remove legacy shell scripts
