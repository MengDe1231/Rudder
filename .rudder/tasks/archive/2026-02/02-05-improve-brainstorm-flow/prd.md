...
改进 `/rudder:brainstorm` 流程，使其更高效、更智能，减少无价值的问题，提升用户体验。
...
- `.claude/commands/rudder/brainstorm.md` - brainstorm 流程定义
- `.rudder/scripts/task.py` - 任务创建脚本
