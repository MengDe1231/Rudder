...
**EN + ZH**：
- `guide/ch01-what-is-rudder.mdx` — 卖点 "Plan Agent rejects oversized requirements"
...
- `blog/use-k8s-to-know-rudder.mdx` — 技术 blog 里也提了

### Ralph Loop（24 处文件，最广泛）

**EN + ZH + blog**：
- `guide/ch01-what-is-rudder.mdx` L19, L33 — 核心卖点
...
- `blog/use-k8s-to-know-rudder.mdx` — 技术 blog
...
"next_action"                   → 同上
"worktree.yaml"                 → 出现处都可改为 ".rudder/config.yaml"
...
- **`blog/use-k8s-to-know-rudder.mdx`**：作为 thought-piece 可保留，但末尾加 disclaimer "本文写于 0.4.x 时代，Ralph Loop / Plan Agent 已在 0.5.0-beta.0 移除"
