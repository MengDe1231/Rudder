...
This file is referenced from `implement.jsonl`. If Rudder's inject-subagent-context.py is working on Claude Code, the full contents of this file will be injected into the sub-agent's prompt.
