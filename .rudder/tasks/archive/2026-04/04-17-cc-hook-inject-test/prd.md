...
Test whether Rudder's `inject-subagent-context.py` hook actually injects context into Claude Code sub-agents (Task/Agent tool).
...
3. Sub-agent confirms it received Rudder-formatted context blocks (e.g. `=== .../prd.md (Requirements) ===` header)
