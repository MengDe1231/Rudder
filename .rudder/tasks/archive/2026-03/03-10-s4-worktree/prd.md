...
| 文件 | 改动 |
|------|------|
| `packages/cli/src/templates/rudder/scripts/multi_agent/start.py` | submodule 按需 init |
| `packages/cli/src/templates/rudder/scripts/multi_agent/create_pr.py` | submodule 感知 commit/PR |
| `packages/cli/src/templates/rudder/scripts/multi_agent/cleanup.py` | submodule PR 提醒（Cross-Layer #3） |
| `packages/cli/src/templates/rudder/scripts/common/config.py` | `get_submodule_packages()`（S1 已加） |
...
| CHALLENGE | #6 分支命名冲突风险 | 改为 `rudder/<main-branch>` 前缀 |
