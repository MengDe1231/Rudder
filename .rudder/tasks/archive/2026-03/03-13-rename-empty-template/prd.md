...
User feedback: `rudder init` 的模板选择中 "empty templates" 这个命名很奇怪。从产品角度应该叫 "from scratch"，并且不应该真的是空的 — 应该让 AI 根据项目情况自动生成初始内容。
...
- Affects: `rudder init` interactive prompt (template selection)
