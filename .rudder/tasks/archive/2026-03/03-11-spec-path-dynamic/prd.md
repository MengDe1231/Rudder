...
| 命令 | 平台数 | 硬编码内容 |
|------|--------|-----------|
| `finish-work` | 10 | checklist "Does `.rudder/spec/backend/` need updates?" |
| `break-loop` | 10 | checklist "Update `.rudder/spec/backend/` or `frontend/` docs" |
| `integrate-skill` | 10 | 映射表 `spec/frontend/`, `spec/backend/` |
| `onboard` | 10 | grep 命令 `spec/backend/*.md` |
| `create-command` | 6 | 示例 "Reference `.rudder/spec/frontend/index.md`" |
