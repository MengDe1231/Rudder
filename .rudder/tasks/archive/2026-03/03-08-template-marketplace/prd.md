# Rudder Template Marketplace

## Goal

建设 Rudder 的 Template 市场，让用户可以浏览、下载、发布社区 spec/skill/command 模板。
...
- 官方 marketplace 计划托管在 `MengDe1231/docs` 仓库
- 官方 index URL: `https://raw.githubusercontent.com/MengDe1231/docs/main/marketplace/index.json`
...
- 引导用户到 `docs.tryrudder.app/templates/specs-index` (待建设)
