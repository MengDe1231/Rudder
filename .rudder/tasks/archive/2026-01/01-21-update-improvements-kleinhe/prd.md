# PRD: Improve Rudder Update with File Descriptions and Migration Support

## Overview

改进 `rudder update` 命令，添加文件描述功能和迁移系统支持，提升用户体验和版本升级可靠性。

## Background

当前 `rudder update` 命令存在以下不足：
...
```
Updating templates...
  ✓ .rudder/workflow.md - Development workflow guide
  ✓ .rudder/scripts/task.sh - Task management script
  ⚠ .rudder/spec/backend/index.md - Backend guidelines (modified by user)
```
