...
> Purpose: Inform Rudder README redesign
...
**Key Observations**:
- Almost identical positioning to Rudder
...
### 4. Can "Governance" Express Rudder Core Value?

| Problem | Rudder Solution | Does "Governance" Express It? |
|---------|------------------|------------------------------|
...
**Direction A: Use Metaphor (Like Rudder Name Itself)**
> *"Guide AI's wild growth along a disciplined path"*
> *"让 AI 的能力沿着正确的方向生长"*

Rudder (藤架) is already a perfect metaphor — **guiding, not constraining**.
...
### 6. Claude Code Plugin vs Rudder Distinction

| Feature | Claude Code Plugin (Global) | Rudder (Project-Level) |
|---------|---------------------------|------------------------|
| Install Location | `~/.claude/plugins/` | Project `.claude/` + `.rudder/` |
| Scope | All projects share | Current project only |
| Install Method | `npm install -g` or `/plugin` | `rudder init` |

**Conclusion**: Rudder uses Claude Code's **project-level configuration capability**, not the global Plugin system. This is by design — each project needs different guidelines and tracking.

### 7. Recommendation

- **Do NOT use** "AI coding 治理框架" as tagline
- **Recommended**: Continue with Rudder **vine metaphor**, or use developer-friendly terms: harness, rails, guide
