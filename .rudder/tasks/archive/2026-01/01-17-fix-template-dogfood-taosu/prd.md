...
| 当前问题 | 修正 |
|---------|------|
| 读 `.rudder/structure/backend/` | 改回 `src/templates/markdown/structure/backend/*.md.txt` |
| 读 `.rudder/structure/frontend/` | 改回 `src/templates/markdown/structure/frontend/*.md.txt` |
| 读 `.rudder/structure/guides/` | 改回 `src/templates/markdown/guides/*.md.txt` |
| 读 `.rudder/workflow.md` | 改回 `src/templates/markdown/workflow.md.txt` |
...
- [ ] structure 文件使用通用模板（不是 Rudder 项目特定的）
- [ ] `pnpm build` 成功
- [ ] `pnpm typecheck` 通过
- [ ] `pnpm lint` 通过
