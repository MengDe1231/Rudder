...
将 `.rudder/scripts/` 下的 19 个 shell 脚本 1:1 迁移为 Python 脚本，保持相同的逻辑和接口。
...
.rudder/scripts-shell-archive/  # Archived shell scripts
├── common/
├── multi-agent/
└── *.sh
```
...
Updated files:
- `src/templates/rudder/index.ts` - Export Python scripts instead of shell
- `src/templates/rudder/scripts/` - Now contains Python scripts only
- `src/templates/rudder/scripts-shell-archive/` - Archived shell scripts
- `src/templates/extract.ts` - Added `.py` file permission handling
- `src/commands/update.ts` - Updated imports and file mappings

### 4. .gitignore Updates

Added to `.rudder/.gitignore`:
```
# Python cache
**/__pycache__/
**/*.pyc
...
- `rudder init` now creates Python-only scripts directory
...
**Rudder Templates:**
- `src/templates/rudder/workflow.md` - All script references updated to Python
...
- `src/templates/claude/commands/rudder/parallel.md` - All script references
- `src/templates/claude/commands/rudder/record-session.md` - All script references
- `src/templates/claude/commands/rudder/start.md` - All script references
- `src/templates/claude/commands/rudder/onboard.md` - All script references

**Cursor Templates:**
- `src/templates/cursor/commands/rudder-start.md` - All script references
- `src/templates/cursor/commands/rudder-record-session.md` - All script references
- `src/templates/cursor/commands/rudder-onboard.md` - All script references

**Rudder Project's Own Files:**
- `.rudder/workflow.md` - All script references updated to Python
