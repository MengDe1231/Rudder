# Rudder Workflow Context Injection Map
...
**典型 implement.jsonl 示例** (来自 rudder-agents-gui 任务):
```jsonl
{"file": ".rudder/workflow.md"}           → ~2,871 tokens
{"file": ".rudder/spec/frontend/index.md"} → ~335 tokens
```
