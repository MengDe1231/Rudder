# Rudder Context Consumption Benchmark

## Background

A community user asked: "Have you tested how much context the Rudder + Skill + MCP approach consumes?"

This task documents and tests the actual context consumption of the Rudder framework.
