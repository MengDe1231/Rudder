...
- `Rudder/.claude/` has `agents/`, `commands/`, `hooks/`, `settings.json` but **no `.mcp.json`**.
...
- **No existing examples** in Rudder source of programmatic Claude Agent SDK MCP wiring — this benchmark will be the first.
