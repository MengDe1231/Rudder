...
<sub>用 Gemini 写前端，Claude Code 写后端，Codex 代码审查，或者交给团队接力开发 —— Rudder 将上下文、规范与标准在所有平台和团队内部之间共享，无需 handoff 就可以接着之前的进度继续开发，而且任何人的最佳实践都能提升整个团队的能力。</sub>
</p>
...
<a href="https://docs.tryrudder.app/zh/start/real-world-scenarios">使用场景</a>
</p>
...
3. **交由 AI 自主推进** —— AI 会调用 `rudder-implement` 编写代码，并自动依据 Spec、lint、type-check 与测试进行校验。
4. **当工作完成或会话上下文接近上限时，输入 `/rudder:finish-work`**。Rudder 会归档任务并更新工作日志。
...
| 需求 | 链接 |
| --- | --- |
| 在仓库中安装 Rudder | [快速开始](https://docs.tryrudder.app/zh/start/install-and-first-task) |
| 了解各平台之间的差异 | [支持平台](https://docs.tryrudder.app/zh/advanced/multi-platform) |
| 查看实际使用场景 | [真实场景](https://docs.tryrudder.app/zh/start/real-world-scenarios) |
| 从 Spec 模板起步 | [Spec 模板](https://docs.tryrudder.app/zh/templates/specs-index) |
| 跟进版本更新 | [更新日志](https://docs.tryrudder.app/zh/changelog) |
