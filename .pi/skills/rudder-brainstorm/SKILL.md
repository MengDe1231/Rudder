...
Triggered from /rudder-start when the user describes a development task, especially when:
...
| Command | When to Use |
|---------|-------------|
| `/rudder-start` | Entry point that triggers brainstorm |
| `/rudder-finish-work` | After implementation is complete |
| `/rudder-update-spec` | If new patterns emerge during work |
