...
Creates:
- `.rudder/.developer` - Identity file
- `.rudder/workspace/<name>/` - Personal workspace
- `.rudder/workspace/<name>/index.md` - Personal index
- `.rudder/workspace/<name>/journal-1.md` - First journal
...
## Active Work
- Current task: `.rudder/tasks/01-31-add-login-taosu`
- Branch: feature/add-login
