...
|--------|---------|-------|
| Workspace | Session tracking, journals | `.rudder/workspace/` |
| Tasks | Work item tracking | `.rudder/tasks/` |
| Specs | Coding guidelines | `.rudder/spec/` |
| Commands | Slash command prompts | `.claude/commands/` |
| Scripts | Automation utilities | `.rudder/scripts/` (core subset) |
...
1. Read `.rudder/workflow.md`
2. Read relevant specs from `.rudder/spec/`
3. Run `python3 .rudder/scripts/task.py current --source` for active work
...
| Document | Content |
|----------|---------|
| `files.md` | All files in `.rudder/` with purposes |
