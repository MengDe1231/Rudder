...
Documentation for the Rudder agent system - specialized AI agents for different development phases.

---

## Overview

Rudder uses **specialized agents** for different tasks. Each agent has specific capabilities, restrictions, and context injection.
...
inject-subagent-context.py runs
            ...
            │   {"file": ".rudder/spec/cli/backend/index.md", "reason": "..."}
...
### Task Workflow (from /rudder:start)
...
```jsonl
{"file": ".rudder/spec/my-spec.md", "reason": "My agent spec"}
```
