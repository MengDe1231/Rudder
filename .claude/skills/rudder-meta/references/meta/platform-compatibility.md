...
Detailed guide on Rudder feature availability across different AI coding platforms.

---

## Overview

Rudder is designed primarily for **Claude Code** but provides partial support for **Cursor**. Future support for **OpenCode** is under consideration.
...
|---------|----------|-------------|
| Workspace system | `.rudder/workspace/` | Journals, session history |
| Task system | `.rudder/tasks/` | Task tracking, requirements |
| Spec system | `.rudder/spec/` | Coding guidelines |
...
| Developer identity | `.rudder/.developer` | Who is working |
| Current task | `.rudder/.runtime/sessions/` | Session-scoped active task state |
...
For teams using Cursor, here's how to get partial Rudder benefits:
...
```
1. Session Start
   - Read .rudder/workflow.md
   - Read relevant specs from .rudder/spec/
...
| Rudder Version | Claude Code | Cursor | OpenCode |
|-----------------|-------------|--------|----------|
...
├── YES → Full Rudder support (Claude Code)
