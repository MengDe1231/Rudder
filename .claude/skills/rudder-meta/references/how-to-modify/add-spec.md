...
|------|--------|----------|
| `.rudder/spec/mobile/index.md` | Create | Yes |
| `.rudder/spec/mobile/*.md` | Create | Yes |
| Task JSONL templates | Update | Yes |
| `rudder-local/SKILL.md` | Update | Yes |
...
Create `.rudder/spec/mobile/index.md`:
...
def init_mobile_context(task_dir):
    ...
    with open(jsonl_path, "a") as f:
        f.write(json.dumps({
            "file": ".rudder/spec/mobile/index.md",
...
```jsonl
{"file": ".rudder/spec/mobile/index.md", "reason": "Mobile guidelines"}
{"file": ".rudder/spec/mobile/architecture.md", "reason": "Architecture patterns"}
```

---

## Step 5: Document in rudder-local
