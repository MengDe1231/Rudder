...
```jsonl
{"file": ".rudder/spec/cli/frontend/index.md", "reason": "Frontend overview"}
{"file": ".rudder/spec/cli/frontend/component-guidelines.md", "reason": "Component patterns"}
```
...
```
1. Read .rudder/spec/{category}/index.md
...
```bash
touch .rudder/spec/cli/frontend/new-pattern.md
```
...
```bash
mkdir .rudder/spec/mobile
```

### 2. Create Index

```bash
touch .rudder/spec/mobile/index.md
```
