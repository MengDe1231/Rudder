...
Follow the format of existing skill pages (see `docs-site/skills-market/rudder-meta.mdx` as reference):
...
```bash
npx skills add MengDe1231/Rudder/marketplace --skill <skill-name>
```
