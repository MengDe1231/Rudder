...
description: |
  Rudder research agent. Use this exact agent for Rudder task research and research/ persistence. Do not use generic/default/generalPurpose agents for Rudder research.
