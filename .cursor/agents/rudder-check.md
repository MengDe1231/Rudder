...
name: rudder-check
description: |
  Rudder quality check agent. Use this exact agent for Rudder task verification, check.jsonl context injection, and self-fixing code review. Do not use generic/default/generalPurpose agents for Rudder checks.
